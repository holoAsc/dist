...
const WeatherSnap = () => {
    const [temperature] = React.useState(N.rand(0, 30));
...
const Infos = () => {
    return (React.createElement("div", { className: "dates" },
        React.createElement(Dates)));
};
const Dates = () => {
    const date = useCurrentDateEffect();
    return (React.createElement("span", { className: "dates" }, T.formatDate(date)));
};
const Time = () => {
    const date = useCurrentDateEffect();
...
const QuickNav = () => {
    const getItems = () => {
        return [{
                id: 1,
                label: "GPT",
                url: "http://175.24.183.63:8082"
            }, {
                id: 2,
                label: "FRP",
                url: "http://175.24.183.63:7500"
            }, {
                id: 3,
                label: "FILE",
                url: "http://175.24.183.63/file"
            }, {
                id: 4,
                label: "DHT",
                url: "http://175.24.183.63:8082"
            }].map((item) => {
            return (React.createElement("a", { key: item.id, id: "quick-nav-link", href: item.url, target: "_blank" },
                React.createElement("div", { className: "quick-nav-item clear-button" },
    ...
    return (React.createElement("div", { id: "app-menu" },
        React.createElement("div", { id: "app-menu-content-wrapper" },
            React.createElement("div", { id: "app-menu-content" },
                ...
                React.createElement("a", { id: "youtube-link", className: "clear-button", href: "https://www.baidu.com/", target: "_blank" },
                    React.createElement("i", { className: "fa-brands fa-youtube" }),
                    React.createElement("span", null, "进入主页")),
